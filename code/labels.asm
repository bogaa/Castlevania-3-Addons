...
{ ; ram labels 
  ...
  { ; ram audio 
      ...
      r_InstrumentsFramesUntilNextByteProcessed = $100
      r_InstrumentsSoundIdxes = $107
      r_InstrumentsSpeedCtrler_todo = $10E
      r_SoundControlByte = $115
      r_SoundCtrsForLastLoop = $11C
      r_InstrumentData_lo = $123
      r_InstrumentData_hi = $12A
      r_LoopToAddr_lo = $131
      r_LoopToAddr_hi = $138
      r_AudioChannelCodaAddressLowByte = $13F
      r_AudioChannelCodaAddressHighByte = $146
      r_InstrumentLastFreq_hi = $14D
      r_AudioChannelVolum = $154
      r_PauseSoundPlayed = $167
      r_AudioChannelAttributesDuty = $16E
      r_InstrumentFrequencyAdjust = $173
      r_InstrumentLastFreq_lo = $178
      r_OctaveIncreasedBy5minusThis = $17D
      r_InstrumentFrequency_lo = $183
      r_InstrumentFrequency_hi = $186
      r_InstrumentEnvelope1Idx = $189
      r_CurrInstrumentHwRegOffset = $18C
      r_SoundCounterForGlobalDelayFrames = $18D
      r_SoundGlobalDelayFrames = $18E
      r_SoundShouldSkipDecDelayBytes = $18F
      r_AudioSFXSquareSweep = $190
      r_CurrentlyPlayingDMCSoundIdx = $192
      r_AudioTriangleStaccatoTimer = $193
      r_InstrumentDataBanks = $195
      r_AudioSFXSquare1SweepWriteTo4001 = $19C
      r_StackEnd = $1FF
      r_Oam = $200
      r_VramQueue = $300
      r_AudioChannelVolumeEnvelopeDuration = $3C0
      r_AudioChannelVolumeEnvelopePosition = $3C3
      r_AudioChannelVolumeEnvelopeLoopCount = $3C6
      r_AudioChannelVolumeEnvelopeLoopPoint = $3C9
      r_AudioChannelFadeoutPoint = $3CC
      r_AudioChannelVolumeEnvelope = $3CF
      r_AudioChannelNextFadeDuration = $3D2
      r_AudioChannelFadeDuration = $3D5
      r_AudioChannelAlternateDutyCycle = $3D8
      r_AudioChannelNextPitchbendDuration = $3DB
      r_AudioChannelPitchbendDuration = $3DE
      r_AudioChannelSweepRate = $3E1
      r_3e4 = $3E4
  
  
      r_InstrumentEnvelopeLoopToIdx = $6A0
      r_InstrumentsCurrEnvelopeInUse = $6A3
      r_InstrumentsEnvelopeIdx = $6A6
      r_InstrumentsCurrEnvelopeLoops = $6A9
      r_TimeSpecialDMCSoundPlayed = $6C8
      r_sound_musicStop = $6C9
  }
