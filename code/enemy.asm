...
{ ; -- enemy AI state code -----------------------------------------------------------			
	...
	AI_IDX_fallTillGroundSmall_6d:
			...
			CODE_0B8164:
						...
						dw setMovmentSpdZero                 ;0B8168|        |0FFEC8;
	...
	AI_IDX_addSpeedFromScript_1e:
						...
						db $20                               ;0B83CC|        |      ;
						dw setMovmentSpdZero                 ;0B83CD|        |0FFEC8;
	...
	AI_IDX_clearEntityBottom_44:
						...
						dw setMovmentSpdZero                 ;0B856A|        |0FFEC8;
	...
	AI_IDX_seekGround_10:
				...
				noDropled:
						...
						db $20                               ;0B859C|        |      ;
						dw setMovmentSpdZero                 ;0B859D|        |0FFEC8;
	...
	AI_IDX_frog_jump_5c:
			...
			CODE_0B860C:
						...
						dw setMovmentSpdZero                 ;0B8618|        |0FFEC8;
		...
		AI_IDX_fishman_goWater_60:
						...
						db $20                               ;0B87CF|        |      ;
						dw setMovmentSpdZero                 ;0B87D0|        |0FFEC8;
		...
		AI_IDX_fishman_script_JumpSpd_target_63:
						...
						db $20                               ;0B8800|        |      ;
						dw setMovmentSpdZero                 ;0B8801|        |0FFEC8;
		...
		AI_IDX_attack_98:
						...
						db $20                               ;0B8814|        |      ;
						dw setMovmentSpdZero                 ;0B8815|        |0FFEC8;
			...
			CODE_0B88B3:
						...
						dw setMovmentSpdZero                 ;0B88BA|        |0FFEC8;
			...
			AI_IDX_zombieGround_1c:
						...
						db $20                               ;0B894F|        |      ;
						dw setMovmentSpdZero                 ;0B8950|        |0FFEC8;
			...
			AI_IDX_zombi_script2Target_1d:
						...
						db $20                               ;0B8990|        |      ;
						dw setMovmentSpdZero                 ;0B8991|        |0FFEC8;
			...
			AI_IDX_harpyHunchBackSpawn_92:
						...
						db $20                               ;0B8B1F|        |      ;
						dw clearEntityAll                    ;0B8B20|        |0FFED7;
			...
			AI_IDX_hunchBack_93:
						...
						db $20                               ;0B8B6C|        |      ;
						dw setMovmentSpdZero                 ;0B8B6D|        |0FFEC8;
			...
			AI_IDX_hunchBack_94:
						...
						db $20                               ;0B8B85|        |      ;
						dw setMovmentSpdZero                 ;0B8B86|        |0FFEC8;
			...
			AI_IDX_script_sprite_SpdX_3a:
						...
						dw setMovmentSpdZero                 ;0B8BED|        |0FFEC8;
			...
			AI_IDX_spiderString_50:
						db $20                               ;0B8C22|        |      ;
						dw setMovmentSpdZero                 ;0B8C23|        |0FFEC8;
			...
			AI_IDX_spiderSetStartPosY_51:
						...
						db $20                               ;0B8C70|        |      ;
						dw setMovmentSpdZero                 ;0B8C71|        |0FFEC8;
			...
			CODE_0B8C77:
						...
						db $20                               ;0B8C82|        |      ;
						dw setMovmentSpdZero                 ;0B8C83|        |0FFEC8;
			...
			spawnEnemyInSlot:
						db $20                               ;0B8DCF|        |      ;
						dw clearEntityAll                    ;0B8DD0|        |0FFED7;
			...
			spawnSpoorLoop:
						...
						db $20                               ;0B8F53|        |      ;
						dw clearEntityAll                    ;0B8F54|        |0FFED7;
			...
			DATA8_0B9192:
						db $20                               ;0B9192|        |      ;
						dw setMovmentSpdZero                 ;0B9193|        |0FFEC8;
			...
			CODE_0B91E2:
						...
						db $20                               ;0B924A|        |      ;
						dw setMovmentSpdZero                 ;0B924B|        |0FFEC8;
			...
			DATA8_0B9254:
						db $20                               ;0B9254|        |      ;
						dw setMovmentSpdZero                 ;0B9255|        |0FFEC8;
			...
			AI_IDX_walkCol_3b:
						...
						db $20                               ;0B928B|        |      ;
						dw setMovmentSpdZero                 ;0B928C|        |0FFEC8;
			...
			CODE_0B931B:
						...
						db $20                               ;0B9330|        |      ;
						dw setMovmentSpdZero                 ;0B9331|        |0FFEC8;
			...
			CODE_0B9342:
						...
						db $20                               ;0B9344|        |      ;
						dw setMovmentSpdZero                 ;0B9345|        |0FFEC8;
			...
			AI_IDX_skellyWalkJump_35:
						...
						db $20                               ;0B935E|        |      ;
						dw setMovmentSpdZero                 ;0B935F|        |0FFEC8;
			...
			AI_IDX_owl_stop_83:
						...
						db $20                               ;0B94E5|        |      ;
						dw setMovmentSpdZero                 ;0B94E6|        |0FFEC8;
			...
			AI_IDX_startFalling_3e:
						db $20                               ;0B9503|        |      ;
						dw setMovmentSpdZero                 ;0B9504|        |0FFEC8;
			...
			AI_IDX_moveUp_3d:
						...
						db $20                               ;0B951B|        |      ;
						dw setMovmentSpdZero                 ;0B951C|        |0FFEC8;
			...
			CODE_0B9522:
						...
						db $20                               ;0B952E|        |      ;
						dw setMovmentSpdZero                 ;0B952F|        |0FFEC8;
			...
			slimDisapearTop:
						db $20                               ;0B957F|        |      ;
						dw setMovmentSpdZero                 ;0B9580|        |0FFEC8;
			...
			DATA8_0B95AE:
						db $20                               ;0B95AE|        |      ;
						dw setMovmentSpdZero                 ;0B95AF|        |0FFEC8;
			...
			AI_IDX_startMov_hurt_4a:
						...
						db $20                               ;0B9651|        |      ;
						dw setMovmentSpdZero                 ;0B9652|        |0FFEC8;
			...
			AI_IDX_birdMovement_49:
						...
						db $20                               ;0B96A0|        |      ;
						dw setMovmentSpdZero                 ;0B96A1|        |0FFEC8;
		...
		bird_1_xSpdSub:
			...
			AI_IDX_knight_groundCheck_6b:
						...
						db $20                               ;0B99A8|        |      ;
						dw setMovmentSpdZero                 ;0B99A9|        |0FFEC8;
			...
			CODE_0B9A28:
						...
						db $20                               ;0B9A2D|        |      ;
						dw setMovmentSpdZero                 ;0B9A2E|        |0FFEC8;
			...
			AI_IDX_boneDragonHead_77:
						...
						db $20                               ;0B9A54|        |      ;
						dw setMovmentSpdZero                 ;0B9A55|        |0FFEC8;
			...
			CODE_0B9B02:
						...
						db $20                               ;0B9B05|        |      ;
						dw setMovmentSpdZero                 ;0B9B06|        |0FFEC8;
			...
			CODE_0B9E0C:
						...
						db $20                               ;0B9E11|        |      ;
						dw clearEntityAll                    ;0B9E12|        |0FFED7;
...
;						nop #$9
						...
						jsr setMovmentSpdZero                 ;0BA060|        |0FFEC8;						
			...
			DATA8_0BA077:
						...
						db $20                               ;0BA07E|        |      ;
						dw setMovmentSpdZero                 ;0BA07F|        |0FFEC8;
...
;						nop #$3
			...
			AI_IDX_fallSpeed_fromScript_39:
						db $20                               ;0BA0D8|        |      ;
						dw setMovmentSpdZero                 ;0BA0D9|        |0FFEC8;
			...
			CODE_0BA2DC:
						JSR.W CODE_0BA278                    ;0BA2DC|2078A2  |0BA278;
			...
			AI_IDX_attack_97:
						...
						jmp setMovmentSpdZero                 ;0BA46B|        |0FFEC8;
...
; --------------- general ---------------------------------------------------------------
			...
			CODE_0BB22E:
						...
						db $20                               ;0BB24A|        |      ;
						dw setMovmentSpdZero                 ;0BB24B|        |0FFEC8;
	...
	clearEntitySpriteAI:
			...
			CODE_0BB5CE:
						JSR.W CODE_0BA278                    ;0BB5CE|2078A2  |0BA278;
...
pullPC			
		...
		if !subweaponDrop == 1 
				...
				destroyItem:
					lda #$04
				+  	sta.w r_entity_AI_IDX, x				; $5c1, x	
					jsr setMovmentSpdZero               	; helps remove the object (normally only on air collecting)
